...
/**
 * The half of the dashboard's mark that only a browser can answer.
 *
 ...
 * reading a board in the preview or the focus view already follows.
 */
export function watchedBeingNamed(
	board: Pick<Board, "lastWrittenBy" | "namedAt" | "seenAt">,
	place: { surface?: "dispatch" | "stage"; focused?: string },
): boolean {
	...
	if (place.surface !== "stage" || !place.focused) return false;
	/*
