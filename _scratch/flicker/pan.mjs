...
await page.mouse.move(750, 500); for (let i = 0; i < 40; i++) await page.mouse.wheel(0, 40); await settle(page, 600);
console.log(JSON.stringify(await page.evaluate(() => window.__read("pan40")), null, 1));
